...
/** Chapter1：重构：第一个示例 */
var createStatementData_js_1 = __importDefault(require("./createStatementData.js"));
var plays = {
...
function beginning() {
    ...
    function statement(invoice, plays) {
        return renderPlainText(createStatementData_js_1["default"](invoice, plays));
    }
    ...
    function htmlStatement(invoice, plays) {
        return renderHtml(createStatementData_js_1["default"](invoice, plays));
    }
