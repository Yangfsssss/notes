...
const node = new NodeConstructor(2);
...
function walkBFSWithLevel(node) {
    if (node === null) {
        return;
    }
    const queue = [node];
...
// console.log(root1);
//Recursive approach:
function walkPreOrderOfRecursiveApproach(node) {
    if (node === null) {
        return;
    }
    //do something here
...
function walkPreOrderOfIterativeApproach(node) {
    if (node === null) {
        return;
    }
    const stack = [node];
...
//Recursive:
function walkInOrderRecursive(node) {
    if (node === null) {
        return;
    }
    if (node.left) {
...
//Iterative:
function walkInOrderIterative(node) {
    if (node === null) {
        return;
    }
    const stack = [];
...
//Recursive:
function walkPostOrderRecursive(node) {
    if (node === null) {
        return;
    }
    if (node.left) {
...
//Iterative:
function walkPostOrderIterative(node) {
    if (node === null) {
        return;
    }
