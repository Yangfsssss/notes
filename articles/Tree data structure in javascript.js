...
const root = new NodeConstructor(2);
...
console.log(root1);
//Recursive approach:
function walkPreOrderOfRecursiveApproach(root) {
    if (root === null) {
        return;
    }
    //do something here
...
function walkPreOrderOfIterativeApproach(root) {
    if (root === null) {
        return;
    }
    const stack = [root];
...
//Recursive:
function walkInOrderRecursive(root) {
    if (root === null) {
        return;
    }
    if (root.left) {
...
//Iterative:
function walkInOrderIterative(root) {
    if (root === null) {
        return;
    }
    const stack = [];
...
//Recursive:
function walkPostOrderRecursive(root) {
    if (root === null) {
        return;
    }
    if (root.left) {
...
//Iterative:
function walkPostOrderIterative(root) {
    if (root === null) {
        return;
    }
