...
function e3() {
    ...
    salesOffices.trigger('squareMeter88', 2000000);
    salesOffices.trigger('squareMeter110', 3000000);
    return { event: event, installEvent: installEvent };
}
e3();
//8.6 取消订阅的事件
function e4() {
    var _a = e3(), event = _a.event, installEvent = _a.installEvent;
    ...
    var login = {
        ...
        trigger: function (key) {
            ...
            for (var i = 0; i < this.clientList[key].length; i++) {
                ...
                this.clientList[key][i].apply(this.clientList[key], __spreadArray([], args));
            }
        },
        ...
        Event = (function () {
            ...
            _trigger = function (cache, key) {
                ...
                return each(stack, function () {
                    return this.apply(_self, __spreadArray([], args));
                });
            };
            _create = function (namespace) {
                ...
                var ret = {
                    ...
                    trigger: function () {
                        ...
                        var fn;
                        var _self = this;
                        var args = __spreadArray([cache], args);
                        fn = function () {
